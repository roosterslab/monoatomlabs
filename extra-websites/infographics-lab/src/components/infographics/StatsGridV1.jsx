...
import { companyStats } from '../../data/monoatomData';
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-neutral-50 border-2 border-neutral-200 p-8 rounded-lg hover:border-brand-500 hover:shadow-2xl transition-all duration-300 group"
              >
                {/* Icon */}
