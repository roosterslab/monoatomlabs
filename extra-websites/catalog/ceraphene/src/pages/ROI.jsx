...
import { TrendingUp, BarChart2, Target, CheckCircle } from 'lucide-react'
    ...
    <div className="page catalog-page-light page-break" style={{ display: 'flex', flexDirection: 'column', '--light-bg-img': "url('/images/ceraphene-studio.png')" }}>
      ...
      <div style={{ flex: 1, display: 'flex', gap: 0, minHeight: 0 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '16px 18px', gap: 14 }}>
          ...
          <div>
            <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 13, fontWeight: 700, color: '#111827', letterSpacing: 1, textTransform: 'uppercase', marginBottom: 8 }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: 'Inter, sans-serif', fontSize: 10 }}>
              <thead>
                <tr style={{ borderBottom: '2px solid #e5e7eb' }}>
                  <th style={{ padding: '6px 8px', textAlign: 'left', fontWeight: 600, color: '#374151' }}>Product</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', fontWeight: 600, color: '#374151' }}>Initial Cost</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', fontWeight: 600, color: '#374151' }}>Annual Maint.</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', fontWeight: 600, color: '#374151' }}>4-Yr TCO</th>
                  <th style={{ padding: '6px 8px', textAlign: 'center', fontWeight: 600, color: '#374151' }}>Duration</th>
                </tr>
              </thead>
              <tbody>
                {COST_COMPARISON.map((row, i) => (
                  <tr key={i} style={{
                    ...
                    background: row.highlight ? `${COLOR}08` : '#ffffff',
          ...
          <div style={{ background: '#ffffff', border: '1px solid #e5e7eb', borderRadius: 12, padding: '14px', boxShadow: '0 2px 4px -1px rgba(0,0,0,0.03)' }}>
            <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 13, fontWeight: 700, color: '#111827', letterSpacing: 1, textTransform: 'uppercase', marginBottom: 10 }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: 'Inter, sans-serif', fontSize: 10 }}>
              <thead>
                <tr style={{ borderBottom: '2px solid #e5e7eb' }}>
                  <th style={{ padding: '6px 8px', textAlign: 'left', fontWeight: 600, color: '#374151' }}>Fleet</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', fontWeight: 600, color: '#374151' }}>Investment</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', fontWeight: 600, color: '#374151' }}>4-Yr Savings</th>
                  <th style={{ padding: '6px 8px', textAlign: 'right', fontWeight: 600, color: '#374151' }}>Net Gain</th>
                  <th style={{ padding: '6px 8px', textAlign: 'center', fontWeight: 600, color: '#374151' }}>ROI</th>
                </tr>
              </thead>
              <tbody>
                {FLEET_ROI.map((row, i) => (
          ...
          <div style={{ background: '#ffffff', border: '1px solid #e5e7eb', borderRadius: 12, padding: '12px 14px', boxShadow: '0 2px 4px -1px rgba(0,0,0,0.03)' }}>
            <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 12, fontWeight: 700, color: COLOR, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 6 }}>
              Key Value Drivers
            </div>
            {[
          ...
          <div style={{
            ...
            <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 22, fontWeight: 700, color: '#fff', lineHeight: 1 }}>₹3,200+</div>
