...
const PRODUCT = {
  label: 'GRAPHACRETE',
  sub: 'Graphene Concrete Additive',
  color: '#d97706',
  heroImage: '/images/graphacrete-01.jpg',
  tagline: 'Graphene-Enhanced Ready-Mix Concrete Admixture',
  keyMetrics: [
    { value: '+25%', label: 'Compressive' },
    { value: '13%', label: 'Cement Cut' },
    { value: '+30%', label: 'Flexural' },
  ],
}
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', gap: 28 }}>
            ...
            {/* Product name */}
            <div>
              <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: 36, color: C, letterSpacing: '0.04em', lineHeight: 1, textTransform: 'uppercase' }}>{PRODUCT.label}</div>
        ...
        <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
          ...
          {/* Top-right badge */}
          <div style={{ position: 'absolute', top: 20, right: 20, background: 'rgba(5,5,5,0.7)', backdropFilter: 'blur(8px)', border: `1px solid ${C}33`, borderRadius: 6, padding: '6px 12px' }}>
