...
export default function PageHeader({ product, title, pageNum, color, dark = false }) {
  if (dark) {
    return (
      <div style={{
        height: 40,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 10, color: 'rgba(255,255,255,0.3)', letterSpacing: 1 }}>
            Page {pageNum}
          </span>
