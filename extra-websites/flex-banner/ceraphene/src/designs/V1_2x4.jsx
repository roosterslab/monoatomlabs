  ...
  return (
    <div style={{ width: W, height: H, background: '#050505', position: 'relative', overflow: 'hidden', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', borderBottom: `1.5px solid ${C}`,
        ...
        <div style={{ fontSize: Math.max(12, Math.round(18 * s)), fontFamily: "'Outfit', sans-serif", color: '#ffffff', fontWeight: 800, letterSpacing: '0.08em', lineHeight: 1 }}>CERAPHENE</div>
        <div style={{ fontSize: Math.max(5, Math.round(7 * s)), color: C, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Ceramic Car Coating</div>
      </div>
      ...
      <div style={{
        ...
        {[{ val: '9H+', lab: 'Hardness' }, { val: '115°', lab: 'Contact Angle' }, { val: '4 YRS', lab: 'Durability' }].map(({ val, lab }) => (
          <div key={val} style={{ textAlign: 'center', flex: 1 }}>
            <div style={{ fontSize: Math.max(10, Math.round(14 * s)), fontFamily: "'Outfit', sans-serif", fontWeight: 700, color: C_LIGHT, lineHeight: 1 }}>{val}</div>
      ...
      <div style={{
        ...
        {[{ val: '9H+', lab: 'Hard' }, { val: '115°', lab: 'Hydro' }, { val: '4YRS', lab: 'Dura' }, { val: 'NANO', lab: 'Tech' }].map(({ val, lab }) => (
          <div key={val} style={{ flex: 1, background: 'linear-gradient(135deg, #0f172a, #1e293b)', border: `1px solid ${C}`, borderRadius: Math.round(3 * s), display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: Math.round(1 * s) }}>
            <div style={{ fontSize: Math.max(9, Math.round(12 * s)), fontFamily: "'Outfit', sans-serif", fontWeight: 700, color: C_LIGHT, lineHeight: 1 }}>{val}</div>
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', borderTop: `1.5px solid ${C}`,
        display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
        gap: Math.round(1.5 * s), zIndex: 2,
      }}>
        <div style={{ fontSize: Math.max(5, Math.round(7 * s)), color: '#ffffff', letterSpacing: '0.08em', fontStyle: 'italic' }}>Protect. Shine. Endure.</div>
