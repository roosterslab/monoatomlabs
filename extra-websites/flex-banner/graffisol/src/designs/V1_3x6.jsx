  ...
  return (
    <div style={{ width: W, height: H, background: '#050505', position: 'relative', overflow: 'hidden', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: Math.max(16, Math.round(24 * s)), fontFamily: "'Outfit', sans-serif", color: '#ffffff', fontWeight: 800, letterSpacing: '0.08em', lineHeight: 1 }}>GRAFFISOL</div>
