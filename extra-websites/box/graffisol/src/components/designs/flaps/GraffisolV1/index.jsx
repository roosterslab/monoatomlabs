...
import { Package, Sun, Award } from 'lucide-react'
...
const BOX_CONTENTS = [
  { text: '1 × Graffisol Coating (500ml)' },
  { text: '1 × Professional Applicator' },
  { text: '1 × Microfiber Cloth (×2)' },
  { text: '1 × Performance Data Card' },
]

const QCSeal = ({ size }) => (
  <div style={{ width: size, height: size, borderRadius: '50%', border: `1px solid ${C}`, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 4, position: 'relative', boxShadow: `0 0 10px rgba(245, 158, 11, 0.2)` }}>
