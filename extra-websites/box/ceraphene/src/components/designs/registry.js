...
export const DESIGNS = {
  wrap: [
    { id: 'Base',        label: 'Base',                        Component: WrapBase },
  ...
  back: [
    { id: 'Base',        label: 'Base',                        Component: BackBase },
  ...
  flaps: [
    { id: 'Base',        label: 'Base',                        Component: FlapsBase },
  ...
  qr: [
    { id: 'Base',        label: 'Base',                        Component: QRBase },
...
export const DEFAULT_SELECTED = {
  wrap: 'GrapheneV1', back: 'GrapheneV1', flaps: 'GrapheneV1', qr: 'GrapheneV1',
}
