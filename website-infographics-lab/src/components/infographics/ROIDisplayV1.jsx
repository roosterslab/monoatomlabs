          ...
          {roiData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Card Content */}
                <div className="relative bg-neutral-900/80 backdrop-blur border-2 border-neutral-800 p-8 rounded-2xl hover:border-brand-500 transition-all group">
                  {/* Icon */}
