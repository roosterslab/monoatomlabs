        ...
        <section className="py-24 px-6 bg-neutral-900 text-white border-b border-neutral-800 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    <div className="inline-block bg-neutral-800 border border-neutral-700 rounded-full px-6 py-2 text-neutral-300 font-semibold mb-6">
                    ...
                    <h2 className="text-4xl md:text-6xl font-medium mb-6 leading-tight tracking-tight">
                        ...
                        <span className="text-neutral-500">We Scale to Market</span>
                    </h2>

                    <p className="text-xl md:text-2xl leading-relaxed max-w-5xl mx-auto text-neutral-400 font-light">
                    ...
                    {journeyStages.map((stage, index) => {
                        ...
                        return (
                            <div key={index} className="relative">
                                <div className={`bg-neutral-800/50 border-2 ${colors.border} rounded-2xl p-6 hover:bg-neutral-800 transition-all group ${colors.hoverBorder}`}>
                                    ...
                                    <p className="text-sm text-center text-neutral-400">{stage.description}</p>
                                </div>
                                {!isLast && (
                ...
                {/* Key Differentiator */}
                <div className="bg-neutral-800/80 backdrop-blur border border-neutral-700 rounded-2xl p-8 md:p-10 mb-12 text-center">
                    <h3 className="text-3xl font-medium mb-4">Our Unique Approach</h3>
