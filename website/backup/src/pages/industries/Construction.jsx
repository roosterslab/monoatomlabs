        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300">
              High-performance concrete and durable materials for sustainable construction
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <section className="mb-16">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Transform construction projects with graphene-enhanced materials that deliver superior
              strength, durability, and sustainability while reducing environmental impact.
            </p>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 p-8 rounded-lg border border-purple-500/30">
              <h3 className="text-2xl font-bold text-purple-400 mb-4">Graphacrete</h3>
              <p className="text-gray-300 mb-6">
                High-performance concrete additive delivering 40-50% strength gain, 15-20% cement
                reduction, and superior durability.
              </p>
              <Link
          ...
          <section className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link to="/products/graphacrete" className="text-purple-400 hover:text-purple-300 transition-colors">
                → Graphacrete Product Page
              </Link>
