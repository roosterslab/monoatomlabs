    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-24 px-6 border-b border-neutral-200">
        <div className="max-w-7xl mx-auto">
          <p className="text-lg text-neutral-600 mb-16 max-w-4xl">
            Monoatom Labs operates state-of-the-art research and testing laboratories. We have equipment for advanced material synthesis, validation, and scale-up.
          </p>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Facility 01 - Nanomaterials R&D */}
            <div className="p-8 border-2 border-neutral-200 bg-neutral-50 hover:border-neutral-300 transition-colors">
              ...
              <h4 className="text-sm font-medium text-neutral-900 mb-3 uppercase tracking-wide">Capabilities include:</h4>
      ...
      <section className="py-24 px-6 border-b border-neutral-200 bg-neutral-50">
        <div className="max-w-7xl mx-auto">
          <SectionHeading number="01" title="Core Capabilities" theme="light" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            <CapabilityBlock
              ...
              items={[
                'Graphene derivatives and functionalized nanomaterials',
                'Bio-inspired chemistries',
                'Performance-enhancing additives',
                'Advanced dispersion technologies',
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <SectionHeading number="02" title="Research Equipment" theme="light" subtitle="Our state-of-the-art facilities combine advanced instrumentation with expert personnel." />
