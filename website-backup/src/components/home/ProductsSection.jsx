...
import { Layers, Sun, Shield, Beaker, ArrowRight, Zap, Target, Activity } from 'lucide-react';
...
const ProductsSection = () => {
    ...
    return (
        <section id="products" className="relative py-24 px-6 bg-black overflow-hidden">
            {/* 1. Animated Background - High Visibility */}
            <div className="absolute inset-0 z-0">
                <HexagonWave className="w-full h-full opacity-70" />
                {/* Radial mask to keep center clear and edges dark */}
