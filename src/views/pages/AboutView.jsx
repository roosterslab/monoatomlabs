                ...
                <div className="max-w-7xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-xl border border-neutral-100 p-8 grid grid-cols-2 lg:grid-cols-6 gap-8 divide-x divide-neutral-100/50">
                        {[
                            ...
                            >
                                {' '}
                                {/* Responsive border fix logic simplified */}
                                <div
                                    className={`text-3xl md:text-4xl font-display font-bold ${stat.color} mb-1`}
                                >
                                    {stat.value}
                                </div>
            ...
            <section className="py-24 px-6 bg-white text-neutral-900 relative overflow-hidden border-b border-neutral-200">
                <div className="max-w-5xl mx-auto relative z-10 text-center mb-24">
                    ...
                    <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed font-light">
                        We see graphene and advanced nanomaterials as the foundation of a transformation that will touch every
                        aspect of human life—from the air we breathe to the energy we consume.
                    </p>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-lg text-neutral-600 font-light leading-relaxed mb-10">
                                To create commercially viable graphene solutions for industrial applications. We develop,
                                validate, and commercialize graphene innovations to provide:
                            </p>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-white border border-neutral-200 rounded-2xl p-10 shadow-sm">
                                ...
                                <p className="text-neutral-600 leading-relaxed">
                                    Our innovations are designed to deliver superior strength, conductivity, durability, and
                                    environmental efficiency, enabling enterprises to rapidly transition into Industry 4.0.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 mb-24">
                        ...
                        <div className="group lg:pl-12 lg:border-l border-neutral-800">
                            ...
                            <p className="text-neutral-300 leading-relaxed font-light mb-8 pr-8">
                                Promoter of Kalika Steel. Computer Science Engineer with MBA in Technology Management. With
                                over 38 years of experience in steel manufacturing and large-scale industrial operations, he
