...
import { Wind, CheckCircle2, ChevronRight } from 'lucide-react';
            ...
            <div className="grid lg:grid-cols-3 gap-16">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="grid sm:grid-cols-2 gap-6 mb-16">
                  {features.map((item, i) => (
                    <div key={i} className="p-6 rounded-2xl bg-neutral-50 border border-neutral-200 hover:border-teal-300 transition-colors group">
                      <div className="w-10 h-10 bg-white rounded-lg border border-neutral-200 flex items-center justify-center mb-4 text-teal-600 group-hover:scale-110 transition-transform">
              ...
              <div className="lg:col-start-3">
                <div className="sticky top-32 p-8 rounded-3xl bg-neutral-50 border border-neutral-200 shadow-sm">
                  <div className="mb-6">
                    <span className="inline-flex px-3 py-1 rounded-full bg-teal-100 border border-teal-200 text-teal-700 text-xs font-bold uppercase tracking-wider">
                      Field Trials
                    </span>
                  </div>
