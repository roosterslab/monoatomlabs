...
function formatAddress(address) {
  ...
  return address.full || [address.line1, address.line2, address.line3].filter(Boolean).join(', ')
}

const ContactPageTemplate = ({ copy, contact }) => {
  const mergedCopy = {
    ...DEFAULT_COPY,
    ...(copy || {}),
    pageHeader: { ...DEFAULT_COPY.pageHeader, ...(copy?.pageHeader || {}) },
  }
  ...
  return (
    <div className="min-h-screen">
      <PageHeader
        category={mergedCopy.pageHeaderCategory}
        title={mergedCopy.pageHeader.title}
        subtitle={mergedCopy.pageHeader.subtitle}
      />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-neutral-500 font-light">
                We offer flexible partnership structures designed to accelerate commercialization and maximize value.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-10 rounded-3xl border border-neutral-200 shadow-sm hover:border-blue-200 hover:shadow-lg transition-all duration-300 group">
                ...
                <p className="text-neutral-500 mb-8 leading-relaxed font-light">
                  Co-develop, manufacture, and commercialise graphene-enabled products through Joint Ventures. Shared risk,
                  shared IP value creation, and long-term strategic alignment.
                </p>
                <Link to="/contact">
              ...
              <div className="bg-white p-10 rounded-3xl border border-neutral-200 shadow-sm hover:border-purple-200 hover:shadow-lg transition-all duration-300 group">
                ...
                <p className="text-neutral-500 mb-8 leading-relaxed font-light">
                  Rapidly integrate graphene innovations into existing production lines. Access proprietary formulations,
                  processes, and application-specific IP with full technical support.
                </p>
                <Link to="/contact">
