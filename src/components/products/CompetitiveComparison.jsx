...
const CompetitiveComparison = ({ product }) => {
    const comparisons = {
        graphacrete: {
            name: "Graphacrete",
    ...
    const current = comparisons[product];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 bg-green-500/10 border border-green-500/20 px-4 py-2 rounded-full mb-6">
                        ...
                        <span className="text-sm font-bold text-green-700 uppercase tracking-wide">Competitive Advantage</span>
                    </div>
                ...
                <div>
                    <div className={`bg-gradient-to-br ${current.color} text-white rounded-t-2xl p-8`}>
                        <h3 className="text-3xl font-display font-bold mb-2">{current.name}</h3>
                        ...
                        {current.metrics.map((metric, idx) => (
                            ...
                            >
                                <div>
                                    ...
                                    {metric.unit && (
                                        <div className="text-xs text-neutral-500 mt-1 font-light">{metric.unit}</div>
                                    )}
                                </div>
                    ...
                    <div className="mt-8 p-8 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="text-xl font-display font-bold text-neutral-900 mb-3">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="text-center p-8 bg-neutral-900 text-white rounded-2xl">
                        ...
                        <div className="text-neutral-300 font-light">Win Rate on Key Metrics</div>
                    </div>
                    <div className="text-center p-8 bg-neutral-900 text-white rounded-2xl">
                        <div className="text-5xl font-display font-bold mb-2">NABL</div>
                        <div className="text-neutral-300 font-light">Certified Performance Data</div>
                    </div>
                    <div className="text-center p-8 bg-neutral-900 text-white rounded-2xl">
                        <div className="text-5xl font-display font-bold mb-2">Field</div>
                        <div className="text-neutral-300 font-light">Tested in Real Applications</div>
                    </div>
                </div>
