...
import { Building2, Sun, Car, CheckCircle, TrendingUp, ArrowRight, Download, Phone } from 'lucide-react';

const CustomerSuccessStories = ({ product }) => {
    const allStories = [
        {
    ...
    // Filter stories based on product, or show all if no product specified
    const stories = product ? allStories.filter(story => story.product === product) : allStories;
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 bg-green-500/10 border border-green-500/20 px-4 py-2 rounded-full mb-6">
                        ...
                        <span className="text-sm font-bold text-green-700 uppercase tracking-wide">Proven Results</span>
                    </div>
                        ...
                        return (
                            ...
                            >
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                                    ...
                                    <div className={`bg-gradient-to-br ${story.color} text-white p-10 flex flex-col justify-between`}>
                                        <div>
                                            <div className="flex items-center gap-3 mb-6">
                                                ...
                                                <div className="text-sm font-bold opacity-90 uppercase tracking-wide">{story.industry}</div>
                                            </div>
                                        ...
                                        <div className="border-t border-white/20 pt-6">
                                            <div className="text-sm font-bold mb-2 uppercase tracking-wide">The Challenge</div>
                                    ...
                                    {/* Middle & Right Columns - Solution & Results */}
                                    <div className="lg:col-span-2 p-10">
                                        <div className="mb-8">
                                            <h4 className="text-sm font-bold text-neutral-500 mb-3 uppercase tracking-wide">The Solution</h4>
                                        ...
                                        <div className="mb-8">
                                            <h4 className="text-sm font-bold text-neutral-500 mb-4 uppercase tracking-wide">The Results</h4>
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                                {story.results.map((result, idx) => {
                                                    const ResultIcon = result.icon;
                                                    return (
                                                        <div key={idx} className="bg-neutral-50 border border-neutral-200 rounded-lg p-4 hover:border-neutral-900 transition-all">
                                                            <ResultIcon className="w-5 h-5 text-green-600 mb-2" />
                                                            <div className="text-2xl font-display font-bold text-neutral-900 mb-1">
                                                                {result.metric}
                                                            </div>
                                        ...
                                        <div className="bg-neutral-900 text-white rounded-xl p-6 relative">
                                            <div className="text-6xl absolute top-4 left-4 opacity-20 font-serif">"</div>
                                            <p className="text-lg italic mb-4 relative z-10 pl-8 font-light">
                                                {story.quote}
                                            </p>
                                            <div className="text-sm opacity-80 pl-8 font-light">— {story.role}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="mt-16 text-center bg-neutral-900 text-white rounded-2xl p-12">
                    <h3 className="text-3xl font-display font-bold mb-4">Want Similar Results?</h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link to="/contact">
                            <button className="border-2 border-white text-white px-8 py-4 rounded-full font-bold hover:bg-white/10 transition-all inline-flex items-center gap-2">
